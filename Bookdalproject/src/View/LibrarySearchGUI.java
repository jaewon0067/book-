...
public class LibrarySearchGUI {
	...
	private void initialize() {
		...
		panel_2.setLayout(new GridLayout(15, 0, 0, 0));
		...
		btnNewButton.setBounds(281, 0, 73, 34);
		btnNewButton.setFont(new Font("굴림", Font.PLAIN, 16));
		panel_1.add(btnNewButton);
		
		JLabel lblNewLabel = new JLabel("\uB4A4\uB85C \uB3CC\uC544\uAC00\uC11C \uC791\uAC00\uC640 \uCC45 \uC774\uB984\uC73C\uB85C \uAC80\uC0C9\uD558\uC138\uC694~");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(0, 0, 285, 34);
