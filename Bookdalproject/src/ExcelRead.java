            ...
            for(rowindex=0;rowindex<rows;rowindex++){
                ...
                if(row !=null){
                    ...
                    for(columnindex=0; columnindex<=cells; columnindex++){
                        ...
                        BookVO vo = new BookVO(bookinfo[0], bookinfo[1], bookinfo[2], bookinfo[3], bookinfo[4], bookinfo[5], bookinfo[6], bookinfo[7], bookinfo[8], bookinfo[9], bookinfo[10], bookinfo[11], bookinfo[12]);
            			booklist.add(vo);
						}
